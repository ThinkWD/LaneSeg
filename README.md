...
<p align="center">
  <img src="./docs/images/pdseg260_logo.png" align="middle" width = "500" />
</p>
...
[![Version](https://img.shields.io/github/release/PaddlePaddle/pdseg260.svg)](https://github.com/PaddlePaddle/pdseg260/releases)
![python version](https://img.shields.io/badge/python-3.6+-orange.svg)
![support os](https://img.shields.io/badge/os-linux%2C%20win%2C%20mac-yellow.svg)
![stars](https://img.shields.io/github/stars/PaddlePaddle/pdseg260?color=ccf)
</div>
...
* [2022-07-20] :fire: pdseg260 2.6版本发布！详细发版信息请参考[Release Note](https://github.com/PaddlePaddle/pdseg260/releases)。
...
* [2022-04-20] pdseg260 2.5版本发布超轻量级语义分割模型[PP-LiteSeg](./configs/pp_liteseg)，高精度抠图模型PP-Matting，3D医疗影像开发套件[MedicalSeg](./contrib/MedicalSeg)，交互式分割工具EISeg v0.5。
* [2022-01-20] pdseg260 2.4版本发布交互式分割工具EISeg v0.4，超轻量级人像分割方案PP-HumanSeg，以及大规模视频会议数据集[PP-HumanSeg14K](./contrib/PP-HumanSeg/paper.md#pp-humanseg14k-a-large-scale-teleconferencing-video-dataset)。
...
**pdseg260**是基于飞桨PaddlePaddle的端到端图像分割套件，内置**40+模型算法**及**140+预训练模型**，支持**配置化驱动**和**API调用**开发方式，打通数据标注、模型开发、训练、压缩、部署的**全流程**，提供**语义分割、交互式分割、Matting、全景分割**四大分割能力，助力算法在医疗、工业、遥感、娱乐等场景落地应用。
...
* 如果大家有使用问题、产品建议、功能需求, 可以通过[GitHub Issues](https://github.com/PaddlePaddle/pdseg260/issues)提issues。
* 欢迎大家扫码加入pdseg260微信群，和小伙伴们一起交流学习。
    ...
    <tr valign="top">
      ...
      <td>
        <details><summary><b>骨干网络</b></summary>
          <ul>
            <li><a href="./pdseg260/models/backbones/hrnet.py">HRNet</a></li>
            <li><a href="./pdseg260/models/backbones/resnet_cd.py">ResNet</a></li>
            <li><a href="./pdseg260/models/backbones/stdcnet.py">STDCNet</a></li>
            <li><a href="./pdseg260/models/backbones/mobilenetv2.py">MobileNetV2</a></li>
            <li><a href="./pdseg260/models/backbones/mobilenetv3.py">MobileNetV3</a></li>
            <li><a href="./pdseg260/models/backbones/shufflenetv2.py">ShuffleNetV2</a></li>
            <li><a href="./pdseg260/models/backbones/ghostnet.py">GhostNet</a></li>
            <li><a href="./pdseg260/models/backbones/lite_hrnet.py">LiteHRNet</a></li>
            <li><a href="./pdseg260/models/backbones/xception_deeplab.py">XCeption</a></li>
            <li><a href="./pdseg260/models/backbones/vision_transformer.py">VIT</a></li>
            <li><a href="./pdseg260/models/backbones/mix_transformer.py">MixVIT</a></li>
            <li><a href="./pdseg260/models/backbones/swin_transformer.py">Swin Transformer</a></li>
          </ul>
        </details>
        <details><summary><b>损失函数</b></summary>
          <ul>
            <li><a href="./pdseg260/models/losses/binary_cross_entropy_loss.py">Binary CE Loss</a></li>
            <li><a href="./pdseg260/models/losses/bootstrapped_cross_entropy_loss.py">Bootstrapped CE Loss</a></li>
            <li><a href="./pdseg260/models/losses/cross_entropy_loss.py">Cross Entropy Loss</a></li>
            <li><a href="./pdseg260/models/losses/decoupledsegnet_relax_boundary_loss.py">Relax Boundary Loss</a></li>
            <li><a href="./pdseg260/models/losses/detail_aggregate_loss.py">Detail Aggregate Loss</a></li>
            <li><a href="./pdseg260/models/losses/dice_loss.py">Dice Loss</a></li>
            <li><a href="./pdseg260/models/losses/edge_attention_loss.py">Edge Attention Loss</a></li>
            <li><a href="./pdseg260/models/losses/focal_loss.py">Focal Loss</a></li>
            <li><a href="./pdseg260/models/losses/binary_cross_entropy_loss.py">MultiClassFocal Loss</a></li>
            <li><a href="./pdseg260/models/losses/gscnn_dual_task_loss.py">GSCNN Dual Task Loss</a></li>
            <li><a href="./pdseg260/models/losses/kl_loss.py">KL Loss</a></li>
            <li><a href="./pdseg260/models/losses/l1_loss.py">L1 Loss</a></li>
            <li><a href="./pdseg260/models/losses/lovasz_loss.py">Lovasz Loss</a></li>
            <li><a href="./pdseg260/models/losses/mean_square_error_loss.py">MSE Loss</a></li>
            <li><a href="./pdseg260/models/losses/ohem_cross_entropy_loss.py">OHEM CE Loss</a></li>
            <li><a href="./pdseg260/models/losses/pixel_contrast_cross_entropy_loss.py">Pixel Contrast CE Loss</a></li>
            <li><a href="./pdseg260/models/losses/point_cross_entropy_loss.py">Point CE Loss</a></li>
            <li><a href="./pdseg260/models/losses/rmi_loss.py">RMI Loss</a></li>
            <li><a href="./pdseg260/models/losses/semantic_connectivity_loss.py">Connectivity Loss</a></li>
          </ul>
        </details>
      ...
      <td>
        <details><summary><b>支持数据集</b></summary>
          <ul>
            <li><a href="./pdseg260/datasets/ade.py">ADE20K</a></li>  
            <li><a href="./pdseg260/datasets/cityscapes.py">Cityscapes</a></li>
            <li><a href="./pdseg260/datasets/cocostuff.py">COCO Stuff</a></li>
            <li><a href="./pdseg260/datasets/voc.py">Pascal VOC</a></li>
            <li><a href="./pdseg260/datasets/eg1800.py">EG1800</a></li>
            <li><a href="./pdseg260/datasets/pascal_context.py">Pascal Context</a></li>  
            <li><a href="./pdseg260/datasets/supervisely.py">SUPERVISELY</a></li>
            <li><a href="./pdseg260/datasets/optic_disc_seg.py">OPTIC DISC SEG</a></li>
            <li><a href="./pdseg260/datasets/chase_db1.py">CHASE_DB1</a></li>
            <li><a href="./pdseg260/datasets/hrf.py">HRF</a></li>
            <li><a href="./pdseg260/datasets/drive.py">DRIVE</a></li>
            <li><a href="./pdseg260/datasets/stare.py">STARE</a></li>
            <li><a href="./pdseg260/datasets/pp_humanseg14k.py">PP-HumanSeg14K</a></li>
            <li><a href="./pdseg260/datasets/pssl.py">PSSL</a></li>
          </ul>
        </details>
...
* [20分钟快速上手pdseg260](./docs/whole_process_cn.md)
...
## AI Studio第三方教程推荐
* [10分钟上手pdseg260](https://aistudio.baidu.com/aistudio/projectdetail/1672610?channelType=0&channel=0)
* [pdseg260实战之人像分割](https://aistudio.baidu.com/aistudio/projectdetail/2189481?channelType=0&channel=0)
* [pdseg260实战之小数据集3D椎骨分割](https://aistudio.baidu.com/aistudio/projectdetail/3878920)
* [pdseg260实战之车道线图像分割](https://aistudio.baidu.com/aistudio/projectdetail/1752986?channelType=0&channel=0)
* [pdseg260动态图API使用教程](https://aistudio.baidu.com/aistudio/projectdetail/1339458?channelType=0&channel=0)
...
```latex
@misc{liu2021pdseg260,
      title={pdseg260: A High-Efficient Development Toolkit for Image Segmentation},
...
@misc{pdseg2602019,
    title={pdseg260, End-to-end image segmentation kit based on PaddlePaddle},
    author={PaddlePaddle Authors},
    howpublished = {\url{https://github.com/PaddlePaddle/pdseg260}},
    year={2019}
}
```
