...
class Config(object):
    ...
    The following hyper-parameters are available in the config file:
        ...
        train_dataset: A training data config including type/data_root/transforms/mode.
            For data type, please refer to pdseg.datasets.
            For specific transforms, please refer to pdseg.transforms.transforms.
        val_dataset: A validation data config including type/data_root/transforms/mode.
        optimizer: A optimizer config, but currently pdseg only supports sgd with momentum in config file.
        ...
        model: A model config including type/backbone and model-dependent arguments.
            For model type, please refer to pdseg.models.
            For backbone, please refer to pdseg.models.backbones.
    ...
    Examples:
        ...
        from pdseg.cvlibs.config import Config
