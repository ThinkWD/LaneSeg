...
from pdseg.transforms import Compose
from pdseg.datasets import Dataset
from pdseg.utils.download import download_file_and_uncompress
from pdseg.utils import seg_env
import pdseg.transforms.functional as F

URL = "https://pdseg.bj.bcebos.com/dataset/Supervisely_face.zip"
