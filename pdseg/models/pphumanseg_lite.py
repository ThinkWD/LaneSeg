...
from pdseg.cvlibs import manager, param_init
from pdseg.models import layers
from pdseg.utils import utils
...
class PPHumanSegLite(nn.Layer):
    "A self-developed ultra lightweight model from pdseg, is suitable for real-time scene segmentation on web or mobile terminals."
