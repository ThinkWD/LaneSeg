...
"""
This module is used to store environmental parameters in pdseg.

SEG_HOME : Root directory for storing pdseg related data. Default to ~/.pdseg.
...
def _get_seg_home():
    if 'SEG_HOME' in os.environ:
        ...
        if os.path.exists(home_path):
            ...
            return home_path
    return os.path.join(_get_user_home(), '.pdseg')
