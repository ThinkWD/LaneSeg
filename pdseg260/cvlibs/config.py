...
class Config(object):
    ...
    The following hyper-parameters are available in the config file:
        ...
        train_dataset: A training data config including type/data_root/transforms/mode.
            For data type, please refer to pdseg260.datasets.
            For specific transforms, please refer to pdseg260.transforms.transforms.
        val_dataset: A validation data config including type/data_root/transforms/mode.
        optimizer: A optimizer config, but currently pdseg260 only supports sgd with momentum in config file.
        ...
        model: A model config including type/backbone and model-dependent arguments.
            For model type, please refer to pdseg260.models.
            For backbone, please refer to pdseg260.models.backbones.
    ...
    Examples:
        ...
        from pdseg260.cvlibs.config import Config
