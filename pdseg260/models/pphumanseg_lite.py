...
from pdseg260.cvlibs import manager, param_init
from pdseg260.models import layers
from pdseg260.utils import utils
...
class PPHumanSegLite(nn.Layer):
    "A self-developed ultra lightweight model from pdseg260, is suitable for real-time scene segmentation on web or mobile terminals."
