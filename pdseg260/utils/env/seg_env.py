...
"""
This module is used to store environmental parameters in pdseg260.

SEG_HOME : Root directory for storing pdseg260 related data. Default to ~/.pdseg260.
...
def _get_seg_home():
    if 'SEG_HOME' in os.environ:
        ...
        if os.path.exists(home_path):
            ...
            return home_path
    return os.path.join(_get_user_home(), '.pdseg260')
